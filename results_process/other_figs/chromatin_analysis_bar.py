...
ax.set_title('Chromatin dynamics analysis', fontsize = 16)
fig.tight_layout()
fig.savefig(f'Chromatin_dynamics_prediction.pdf',format="pdf", bbox_inches="tight",dpi = 300)
fig = None
plt.close()