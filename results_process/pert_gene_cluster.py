#set +o noclobber
#python pert_gene_cluster.py > txt/pert_gene_cluster_new.txt 2>&1
...
adata = anndata.read_h5ad("/l/users/ding.bai/all_backup/pert_new/mywork/data/norman/perturb_processed.h5ad")
...
pert_names = pert_names[pert_idxes]
data = data[pert_idxes, :][:, gene_idxes]
...
#         standard_scale=1, # Cols
    ...
    plt.rcParams['axes.titley'] = 1.2
    plt.rcParams['axes.titlepad'] = 10
    b.ax_heatmap.set_yticklabels(b.ax_heatmap.get_yticklabels(), size=1.7)
