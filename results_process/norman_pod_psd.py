...
def extract_row(results_df, model, seed):
    model_dict = {
        ...
        'Geneformer': f'geneformer_64_seed_{seed}',
        'scFM-1b': 'scfm_gears_downstream_hs1024-1b-02-05'
...
def process_results(results_df):
    seeds = [1,]
    new_dfs = {}
    new_df_default = {'model': ['Ctrl', 'GEARS','Geneformer', 'scFM-1b']}
...
csv_raw_file = '/home/ding.bai/ding-scfmv1-downstream/GEARS/result_process/csvs/norman_split_and_ctrl_pod_psd.csv'
...
# Plotting     
models = ['Ctrl', 'GEARS','Geneformer', 'scFM-1b']
indices = np.arange(5)
