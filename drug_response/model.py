...
class KerasMultiSourceGCNModel(object):
    ...
    def createMaster(self,drug_dim,mutation_dim,gexpr_dim,methy_dim,units_list,use_relu=True,use_bn=True,use_GMP=True):
        ...
        # print shape of drug_feat_input and drug_adj_input for tensorflow model
        print('drug_feat_input:',drug_feat_input.shape)
        print('drug_adj_input:',drug_adj_input.shape)
