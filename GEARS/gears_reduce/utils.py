...
def filter_pert_cond_in_go(condition, exclude_pert):
    """
...
def get_go_auto(gene_list, data_path, data_name):
    ...
    if os.path.exists(go_path):
        ...
        with open(os.path.join('/home/ding.bai/pert_new/GEARS/data_all/gene2go_all.pkl'), 'rb') as f:
