...
parser.add_argument("--finetune_dataset", type=str,
                    default="/data/luoyingtao/scFM/Genecorpus-30M/genecorpus_30M_2048.dataset")
parser.add_argument("--dosage_sensitivity_TFs_path", type=str, default="dosage_sensitivity_TFs.pickle")
...
with open(args.dosage_sensitivity_TFs_path, 'rb') as f:
  dosage_tfs = pickle.load(f)
sensitive = dosage_tfs["Dosage-sensitive TFs"].dropna()
insensitive = dosage_tfs["Dosage-insensitive TFs"].dropna()
